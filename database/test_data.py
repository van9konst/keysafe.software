...
keys = [{"room": "311", "rfid_s": "111"}, {"room": "11D", "rfid_s": "444"},
        {"room": "212", "rfid_s": "222"}, {"room": "555", "rfid_s": "555"},
        {"room": "343", "rfid_s": "333"}]
...
UserKeyLink.userkeylink_get_key(user1, key1)
UserKeyLink.userkeylink_get_key(user2, key2)
UserKeyLink.userkeylink_get_key(user3, key3)
UserKeyLink.userkeylink_return_key(key3)
